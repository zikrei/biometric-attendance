...
<head>
    ...
    <style>
        ...
        .sidebar { width: 260px; min-height: calc(100vh - 64px); background: #111827; color: #ffffff; padding: 1.25rem 1rem; }
        .sidebar .sidebar-title { font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.08em; color: #9ca3af; margin-bottom: 1rem; }
...
<body>
    <div class="app-wrapper">
        ...
        <div class="layout-body">
            {{-- FIX #1: We successfully added the desktop sidebar inclusion here! --}}
            @if(Auth::check())
    ...
    {{-- FIX #2: Updated the Mobile Sidebar logic to prevent crashes --}}
    @if(Auth::check())
    <div class="offcanvas offcanvas-start mobile-sidebar text-white" tabindex="-1" id="mobileSidebar" aria-labelledby="mobileSidebarLabel">
        ...
        <div class="offcanvas-body">
            <nav class="nav flex-column">
                {{-- Define the role variable so it doesn't crash! --}}
